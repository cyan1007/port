...
const slideSets = {
  set1: [
    {
      ...
      img: "images/cont2/nuri.jpg",
      type: "modal",
      content: `<h3>브랜드 기획 발표내용</h3>  
      <img src="/images/cont2/eumnuri.jpg">
    ...
    },
    {
      ...
      type: "modal",
      content: `
    <img src="/images/cont2/process.png">
    <h3>밥플릭스</h3>
  ...
  `,
    ...
    },
    {
      ...
      img: "images/cont2/sreader.png",
      type: "modal",
      content: `<img src="/images/cont2/ppt.jpg">
      <img src="/images/cont2/s-process.jpg">
...
function openSlideModal(content) {
  const modal = document.getElementById("modal-cont2-slide");
  if (!modal) return;
  const body = modal.querySelector(".modal-cont2-body");
...
function initSlideModalEvents() {
  ...
  modal.querySelector(".modal-cont2-close").addEventListener("click", () => {
